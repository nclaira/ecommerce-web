function About() {
  return (
    <div className="p-8 bg-gray-100 min-h-screen">
      ...
      <div className="max-w-5xl mx-auto bg-amber-100 shadow-md rounded-lg p-8">
        <h2 className="text-2xl font-semibold mb-6 text-green-700 text-center">Why Choose Us</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6" >
          <div className="bg-gray-50 p-6 rounded-lg shadow-sm transition-transform duration-300 hover:scale-105">
