...
function Navbar(){
    ...
    return(
        <nav className="w-full px-3 md:px-10 py-3 md:py-4 border-b border-gray-200 bg-blue-500 text-white">
            <div className="mx-auto max-w-7xl flex items-center justify-between">
                ...
                <button
                    type="button"
                    className="md:hidden inline-flex h-10 w-10 items-center justify-center rounded-md text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-white"
