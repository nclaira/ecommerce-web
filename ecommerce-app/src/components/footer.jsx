...
function Footer() {
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-gray-700 text-gray-900 py-8 md:py-10 mt-12 md:mt-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        ...
        <div>
          ...
          <ul className="space-y-1.5 sm:space-y-2 text-white text-sm sm:text-base text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start space-x-4 mt-4 text-sm sm:text-base">
            <Link to="#" className="text-white hover:text-green-600 transition">Facebook</Link>
            <Link to="#" className="text-white hover:text-green-600 transition">Twitter</Link>
            <Link to="#" className="text-white hover:text-green-600 transition">Instagram</Link>
          </div>
        </div>
      </div>


      <div className="mt-8 md:mt-10 border-t border-gray-300 pt-4 text-center text-white text-xs sm:text-sm">
